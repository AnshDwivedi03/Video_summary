...
import { BookOpen, Search, Moon, Sun, User as UserIcon, LogOut } from "lucide-react";
import { useTheme } from "./ThemeContext";

const Navbar = ({ user, searchQuery, setSearchQuery, onSignInClick }) => {
        ...
        {user ? (
          <div className="flex items-center gap-3 pl-4 border-l border-border-primary">
            <div className="text-right hidden sm:block">
              ...
              <p className="text-[10px] text-text-secondary font-medium uppercase tracking-widest mt-1">Free Tier</p>
            </div>
          ...
          <button 
            ...
            className="px-6 py-2.5 bg-text-primary text-bg-primary rounded-2xl font-bold text-sm hover:opacity-90 transition-opacity flex items-center gap-2"
          >
            <UserIcon size={16} />
            Sign In
          </button>
